---
title: "This script fits models to data and creates plots"
...
source('plot/src/predictIntervals.R')
```
...
```{r}
######################### 
##log floral abundance vs beta dispersion 
######################### 
# abund.dist.plot <- plot(spec.filt, "PlantAbund", abund.mod)
# 
# abund.dist.plot + labs(x = "Partner Variability", y = "Floral Abundance")
...
```{r}
# Save plot
ggsave(filename = "betaDispNetMetricPlot.png",
       plot = combinedPlot,
       path = "figures",      
